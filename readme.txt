1.22 DayZ Chernarus Building, Hunting, Farming, Fishing & Trading PvE xml Mod Changelog & Terms Of Use

Limited Testing on PC Chernarus Local Server DAYZ EXPERIMENTAL Version 1.22 Aug 2023.
...
These XML files will add a one-off Trader Truck parked outside the shop in Novy Sobor. DONE.
...
Latest 1.22 items added: lots of bags! (Tier system not added to existing bags). Fill percentage added to fuel cans, gas canisters, generators (full / almost full).
Tier system not added to mele weapons.
